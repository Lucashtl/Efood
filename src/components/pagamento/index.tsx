...
import { setSidebar } from '../../store/reducers/Carrinho'
import { usePurchaseMutation } from '../../services/api'
import { Botao } from './style'
import { formataPreco } from '../../styles/style'
import ConfirmOrder from '../ConfimOrder/index'
import {
  ButtonContainer,
  FormCheckout,
  InputContent,
    ...
    >
      {() => (
        <FormCheckout>
          ...
          <ButtonContainer>
            <Botao type="submit" title="Continuar com o Pamento">
    ...
    >
      {({ values }) => (
        <FormCheckout>
          ...
          <ButtonContainer>
            <Botao type="submit" title="Finalizar pagamento">
              Finalizar pagamento
            </Botao>
            <Botao
